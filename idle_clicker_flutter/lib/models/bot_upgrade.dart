...
class BotUpgrade {
  ...
  static const List<BotUpgrade> allUpgrades = [
    ...
    BotUpgrade(
      ...
      name: 'Side Hustle',
      emoji: '🛒',
      description: '+\$0.10/sec per level (dropshipping)',
      icon: Icons.shopping_bag,
      category: UpgradeCategory.passive,
      basePrice: 100, // Hook: Affordable in first 2 minutes!
      priceMultiplier: 2.0,
      maxLevel: 10,
      passiveIncomePerLevel: 0.10, // Doubled from 0.05
    ),
    BotUpgrade(
      id: 'vending_machines',
      name: 'Vending Machines',
      emoji: '🥤',
      description: '+\$0.25/sec per level',
      icon: Icons.local_drink,
      category: UpgradeCategory.passive,
      basePrice: 800,
      priceMultiplier: 2.2,
      maxLevel: 10,
      passiveIncomePerLevel: 0.25,
    ),
    BotUpgrade(
      id: 'rental_property',
      name: 'Rental Property',
      emoji: '🏠',
      description: '+\$0.75/sec per level',
      icon: Icons.home,
      category: UpgradeCategory.passive,
      basePrice: 5000,
      priceMultiplier: 2.5,
      maxLevel: 5,
      passiveIncomePerLevel: 0.75,
    ),
    BotUpgrade(
      id: 'dividend_portfolio',
      name: 'Dividend Portfolio',
      emoji: '💰',
      description: '+\$2.00/sec per level',
      icon: Icons.account_balance,
      category: UpgradeCategory.passive,
      basePrice: 25000,
      priceMultiplier: 3.0,
      maxLevel: 5,
      passiveIncomePerLevel: 2.0,
    ),
    BotUpgrade(
      id: 'laundromat',
      name: 'Laundromat Chain',
      emoji: '🧺',
      description: '+\$5.00/sec per level',
      icon: Icons.local_laundry_service,
      category: UpgradeCategory.passive,
      basePrice: 100000,
      priceMultiplier: 3.5,
      maxLevel: 5,
      passiveIncomePerLevel: 5.0,
    ),
    BotUpgrade(
      id: 'business_empire',
      name: 'Business Empire',
      emoji: '🏰',
      description: '+\$15/sec per level (end game)',
      icon: Icons.castle,
      category: UpgradeCategory.passive,
      basePrice: 500000,
      priceMultiplier: 4.0,
      maxLevel: 10,
      passiveIncomePerLevel: 15.0,
    ),
  ];
